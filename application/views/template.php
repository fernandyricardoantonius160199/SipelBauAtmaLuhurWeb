...
<head>
  ...
  <title>ISB | BAU | Pelaporan Kerusakan Sarana Prasarana</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-mini"><b>I</b>SB</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>ISB | </b>BAU</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        $sql_menu = "SELECT * FROM `tabel_menu`";
  ...
  <footer class="main-footer">
    <div class="pull-right hidden-xs">
      <b>Version</b> 17.11.500.123
    </div>
    <strong><center>Copyright &copy; 2021 <a href="https://www.atmaluhur.ac.id/">Institut Sains Dan Bisnis Atma Luhur</a>.</strong> Bagian Administrasi Umum.
  </footer>
