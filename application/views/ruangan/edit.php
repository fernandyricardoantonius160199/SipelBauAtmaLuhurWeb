                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
				   ...
				   <div class="form-group">
                      ...
                      <div class="col-sm-9">
						<?php
                          echo form_dropdown('kondisi_ruangan', array('Pilih Kondisi Ruangan', 'Baik'=>'Baik', 'Kurang Baik'=>'Kurang Baik', 'Rusak Berat'=>'Rusak Berat'), $ruangan['kondisi_ruangan'], "class='form-control'");
                        ?>
                      </div>
                  </div>
